  ...
  const SDFag = [
    {
      ...
      content: (
        <div>
          <p>Оставьте заявку. Наш менеджер свяжется с&nbsp;вами после старта продаж и&nbsp;расскажет о&nbsp;возможностях подключения Membrana для вас и&nbsp;команды</p>
        </div>
      ),
    },
    {
    ...
    {
      title: <span>
        На&nbsp;Membrana могут перейти абоненты других операторов?
      </span>,
      content: <div>
        Да, конечно.
      </div>
    ...
    },
    {
      ...
      content: (
        <div onCopy={() => window.umami.track('email_support_copy')}>
          По всем вопросам:{' '}
          <a style={{ color: 'inherit', textDecoration: 'underline' }} href={'mailto:futurecrew@mts.ru'} target={'_blank'} rel='noreferrer' data-umami-event="email_support">
            <span>futurecrew@mts.ru</span>
          </a>
        </div>
      ),
    },
